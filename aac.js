...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_aac_write')) {
        Object.defineProperty(Module['ready'], '_aac_write', { configurable: true, get: function() { abort('You are getting _aac_write on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_aac_write', { configurable: true, set: function() { abort('You are setting _aac_write on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'aac.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('aac.wasm', import.meta.url).toString();
}
...
var ASM_CONSTS = {
  ...
  /** @type {function(...*):?} */
  function _aac_write_polyfill(
  ) {
  err('missing function: aac_write_polyfill'); abort(-1);
  }
...
var asmLibraryArg = {
  ...
  "aac_write_polyfill": _aac_write_polyfill,
  "abort": _abort,
...
/** @type {function(...*):?} */
var _aac_write = Module["_aac_write"] = createExportWrapper("aac_write");
